...
public class encryption {
    ...
    public void encrypt(ArrayList<String>Key){
        ...
        try{
            ...
            if(plaintxt.length()%8==0)
                break;
            else
                plaintxt+="#";
        }
        byte[]bytes=plaintxt.getBytes();
       ...
       // String binary1="0000000100100011010001010110011110001001101010111100110111101111";
        ...
        for(int i=0;i<Apply_IP.size();i++){
            ...
            for(int j=0;j<16;j++){
                ...
                for(int k=0;k<E.length;k++){
                    ...
                    F_XOR+=XOR(Key.get(j).charAt(k),Expansion.charAt(k));
                }
                String S_Box="";
