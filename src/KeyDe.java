    ...
    public ArrayList key(String input){
        ...
        for(int i=1;i<17;i++){
            ...
            if(i==1){
                ...
                Cn+=Cn_1.charAt(Cn_1.length()-1);
                for(int j=0;j<Cn_1.length()-1;j++){
                    Cn+=Cn_1.charAt(j);
                }
                Cn_1=Cn;
                Dn+=Dn_1.charAt(Dn_1.length()-1);
                for(int j=0;j<Dn_1.length()-1;j++){
                    Dn+=Dn_1.charAt(j);
                }
                Dn_1=Dn;
                C_D=Cn+Dn;
                ...
                Cn+=Cn_1.charAt(Cn_1.length()-1);
                Cn+=Cn_1.charAt(Cn_1.length()-2);
                for(int j=0;j<Cn_1.length()-2;j++){
                    Cn+=Cn_1.charAt(j);
                }
                Cn_1=Cn;
                Dn+=Dn_1.charAt(Dn_1.length()-1);
                Dn+=Dn_1.charAt(Dn_1.length()-2);
                for(int j=0;j<Dn_1.length()-2;j++){
                    Dn+=Dn_1.charAt(j);
                }
                Dn_1=Dn;
                C_D=Cn+Dn;
